...
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_Node15644_Billiards_Stick_Bridge_v2Plugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_Node10477_Satellite_v1_L3Plugin)
Q_IMPORT_QML_PLUGIN(SimdezvousPlugin)
Q_IMPORT_QML_PLUGIN(SimdezvousContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/SimdezvousContent/App.qml";
